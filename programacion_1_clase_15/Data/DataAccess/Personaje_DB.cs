...
namespace programacion_1_clase_15.Data.DataAccess
{
    internal class Personaje_DB
    {
        private string connectionString = "Server=localhost;Database=dbuni;Uid=root;Pwd=Umg$2023";
